...
def run_mp_integration():
    """Main function to wrap all MP integration functionality"""
    ...
    return {
        "cached_query_mp_advanced_filters": cached_query_mp_advanced_filters,
        "cached_query_material": cached_query_material,
        "query_materials_project": query_materials_project,
        "get_mp_property_dataframe": get_mp_property_dataframe,
        "query_mp_advanced_filters": query_mp_advanced_filters
    }

# Initialize the module when imported
mp_functions = None

def get_mp_functions():
    """Lazy loader for MP functions"""
    global mp_functions
    if mp_functions is None:
        mp_functions = run_mp_integration()
    return mp_functions

# Create convenient accessors
def cached_query_mp_advanced_filters(**kwargs):
    return get_mp_functions()["cached_query_mp_advanced_filters"](**kwargs)

def cached_query_material(material_id):
    return get_mp_functions()["cached_query_material"](material_id)

def query_materials_project(term: str, api_key: Optional[str] = None):
    return get_mp_functions()["query_materials_project"](term, api_key)

def get_mp_property_dataframe(mp_json: Dict[str, Any]):
    return get_mp_functions()["get_mp_property_dataframe"](mp_json)

def query_mp_advanced_filters(**kwargs):
    return get_mp_functions()["query_mp_advanced_filters"](**kwargs)