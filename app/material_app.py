...
def run_selection_app():
    ...
    try:
        ...
        def query_materials_project(*args, **kwargs): return None
        def get_mp_property_dataframe(*args, **kwargs): return None
        def cached_query_mp_advanced_filters(*args, **kwargs): return []
        def cached_query_material(*args, **kwargs): return None
